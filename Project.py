...
class UIDesign:
    ...
    def add_college_records(self):
        ...
        cr = db.cursor()
        cr.execute("INSERT INTO College_Records(College_ID, Password, College_Code, College_Name, State, City, Pincode)"
                   " VALUES('" + collegeID + "', '" + self.password1.get() + "', '" + self.college_code.get() + "', "
